  ...
  <table class="min-w-full text-sm">
    <thead class="bg-slate-50 text-slate-600">
      <tr>
        ...
        <th class="text-left px-4 py-2">GA Weeks</th>
        <th class="text-left px-4 py-2">BP</th>
      ...
      <?php else: ?>
        <?php foreach ($rows as $r): ?>
          <tr class="border-t">
            ...
            <td class="px-4 py-2">
              <a class="text-blue-600" href="/HealthLogs/public/maternal/prenatal/form.php?id=<?= (int)$r['id'] ?>">Edit</a>
              <form method="post" action="/HealthLogs/public/maternal/prenatal/delete.php" class="inline">
